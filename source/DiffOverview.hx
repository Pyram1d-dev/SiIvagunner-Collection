...
class DiffOverview extends FlxSubState
{
	...
	override function create()
	{
		...
		SONG = FreeplayState.songData.get(FreeplayState.songs[FreeplayState.curSelected].songName)[FreeplayState.songs[FreeplayState.curSelected].diffs.indexOf(CoolUtil.difficultyFromInt(FreeplayState.curDifficulty))];
	...
	public function generateSong(dataPath:String):Void
	{
		...
		var songData = FreeplayState.songData.get(FreeplayState.songs[FreeplayState.curSelected].songName)[FreeplayState.songs[FreeplayState.curSelected].diffs.indexOf(CoolUtil.difficultyFromInt(FreeplayState.curDifficulty))];
