...
class WelcomeState extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        This mod has a lot of content and jokes packed in, including blueball screens, death dialogue and extra freeplay difficulties. Make sure to set up your options and keybinds.\n\nPlease support the original Friday Night Funkin' and the SiIvagunner YouTube channel!";
        txt.alignment = LEFT;
        txt.updateHitbox();
		txt.screenCenter(XY);
