...
class MusicBeatState extends FlxUIState
{
	...
	override function add(Object:flixel.FlxBasic, toBack:Bool = false):flixel.FlxBasic
	{
		if (!toBack)
			assets.push(Object);
		else 
			assets.unshift(Object);
	...
	{
		if (curStep % 4 == 0)
			if (PlayState.SONG != null && PlayState.SONG.song != null && PlayState.SONG.song.toLowerCase() == "guns short version")
