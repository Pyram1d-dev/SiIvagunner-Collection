...
class StoryMenuState extends MusicBeatState
{
	...
	static function weekData():Array<Dynamic>
	{
		return [
			...
			[
				'Bopeebo Beta Mix', 
				'Bopeebo In-Game Version', 
				'Bopeebo Extended Version', 
				'Bopeebo Newgrounds Build',
				'Fresh',
				'Fresh In-Game Version', 
				'Fresh Alternate Version',
				'Fresh Vocal Mix',
				'Fresh OST Version',       
				'Fresh Poop Version',
				'Dad Battle In-Game Version',
				'Dad Battle In-Game Mix',   
			...
			[
				'Satin Panties',
				'Satin Panties In-Game Version',
				'Ridge',
				"High",
				"High In-Game Version",
				"Milf",
				"Milf Beta Mix",
				"Milf In-Game Version",
				"Milf Itch io Build", 
				"Milf JP Version"
			],
			[
