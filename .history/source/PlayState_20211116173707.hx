		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					trace(poop);
					var lightsOff = StringTools.replace(PlayState.storyPlaylist[0], " ", "-").toLowerCase() == 'fresh'
						|| StringTools.replace(PlayState.storyPlaylist[0], " ", "-").toLowerCase() == 'winter-horrorland-short-version';
					if (lightsOff)
					{
