...
class UnlockedWeekPog extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		bg.alpha = 1;
		var unlockText = new FlxText();
		unlockText.autoSize = false;
		unlockText.setFormat("VCR OSD Mono", 35, FlxColor.WHITE, LEFT, OUTLINE, FlxColor.BLACK);
		unlockText.text = "This mod contains some copyrighted content! (which should be under fair use but, y'know)\n\nPress ENTER to continue\nPress SPACE to enable copyright covers\n\nBe warned, not all of the covers are finished yet. If you're worried about a strike, you can skip the song via the pause menu.";
		unlockText.alignment = LEFT;
