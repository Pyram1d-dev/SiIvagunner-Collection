...
class FreeplayState extends MusicBeatState
{
	...
	public static var songsWithExtraDiffs:Map<String, String>;
		...
		for (i in 0...songs.length)
		{
			...
			if (FlxG.save.data.shortenNames && songName.split(" ").length > 1) // Name shortener
			{
				...
				var converter:Map<String, String> = [
					...
					"alternateversion" => "AV", "itchiobuild" => "Itch Ver.", "poopversion" => "PV", "jpversion" => "JPV", "jpnversion" => "JPNV",
					"week4update" => "Updated", "in-gamemix" => "IGM", "alterneeyyytivemix" => "eyyyy", "shortversion" => "SHORT",
					"newgroundsbuild" => "NG Ver"
