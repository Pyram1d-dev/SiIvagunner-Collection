...
class StoryMenuState extends MusicBeatState
{
	...
	public static unlockedExtras:Map<String, String>
	= [];
	var weekCharacters:Array<Dynamic> = [
		      ['', 'bf', 'gf'],     ['dad', 'bf', 'gf'], ['spooky', 'bf', 'gf'], ['pico', 'bf', 'gf'],        ['mom', 'bf', 'gf'],
		['parents-christmas', 'bf', 'gf'],
		['senpai', 'bf', 'gf'], ['tankman', 'bf', 'gf'], ['whitty', 'bf', 'gf'],     ['kapi', '', ''], ['trickyMask', 'bf', 'gf'],
		                   ['', 'bf', '']
	];
