...
class Alphabet extends FlxSpriteGroup
{
	...
	override function update(elapsed:Float)
	{
		if (isMenuItem)
		{
			...
			y = FlxMath.lerp(y, (scaledY * 120) + (FlxG.height * 0.48), 0.10);
			x = FlxMath.lerp(x, (targetY * 20) + 90, 0.10);
		}
	...
	// Pyram1d: It resets the fuckin midpoints and offsets. I figured out the hard way
