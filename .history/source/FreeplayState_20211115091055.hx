...
class FreeplayState extends MusicBeatState
{
	...
	function createSections()
	{
		...
		var weekNames = [
			"Misc Songs", "Week One", "Week Two", "Week Three", "Week Four", "Week Five", "Week Six", "Week Seven", "Back Alley Blitz", "Arcade Showdown", "Vs Tricky", "Unbeatable"
		];
		var iconPenis = [
		...
		for (i in 0...2/*Std.parseInt(data[2]) + 1*/)
		{
